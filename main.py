...
btn_div = tk.Button(root, text="remain", command=lambda: add_to_calculation("%"), width=5, font=("Ariel", 14), bg='#ffe380', fg='#555555')
btn_div.grid(row=2, column=6)
btn_sin = tk.Button(root, text="sin", command=lambda: add_to_calculation("sin("), width=5, font=("Ariel", 14), bg='#ffe380', fg='#555555')
btn_sin.grid(row=2, column=7)
btn_cos = tk.Button(root, text="cos", command=lambda: add_to_calculation("cos("), width=5, font=("Ariel", 14), bg='#ffe380', fg='#555555')
btn_cos.grid(row=3, column=6)
btn_tan = tk.Button(root, text="tan", command=lambda: add_to_calculation("tan("), width=5, font=("Ariel", 14), bg='#ffe380', fg='#555555')
btn_tan.grid(row=3, column=7)
...
btn_pow = tk.Button(root, text="pow", command=lambda: add_to_calculation("pow("), width=5, font=("Ariel", 14), bg='#2fc8b4', fg='white')
btn_pow.grid(row=5, column=4)
btn_pi = tk.Button(root, text="π", command=lambda: add_to_calculation("pi"), width=5, font=("Ariel", 14), bg='#2fc8b4', fg='white')
btn_pi.grid(row=4, column=5)
btn_e = tk.Button(root, text="e", command=lambda: add_to_calculation("e"), width=5, font=("Ariel", 14), bg='#2fc8b4', fg='white')
btn_e.grid(row=5, column=5)
btn_log = tk.Button(root, text="log", command=lambda: add_to_calculation("log("), width=5, font=("Ariel", 14), bg='#2fc8b4', fg='white')
...
btn_comma = tk.Button(root, text=",", command=lambda: add_to_calculation(","), width=5, font=("Ariel", 14), bg='#D2D2D2', fg='#555555')
